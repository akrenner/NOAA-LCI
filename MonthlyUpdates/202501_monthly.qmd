...
South-central Alaska was hit by a major storm on Sunday, 12 January, bringing hurrican-force 
winds to the Anchorage area and flooding to the Anchor River. Maximal wind speeds 
measured at Homer Airport were 26 knots sustained, gusting to 40 knots.  
...
Temperature and salinity at T9-6 remain close to the long-term mean (2012-present), both in shallow and in deep water layers (@fig-TSprofile_T9). 
...
![Variability of surface-water temperature at T9-6 compared to the seasonal long-term mean.](./media/5-TempSurfaceTS.png){#fig-TempSurf}
