...
While sea-surface-temperatures in most parts of the Pacific remain anomalously warm, the warm-anomaly is not as ubiquitous or severe anymore as it was three months ago. 

Seasonal cooling. Contrast to oceanic water entering at the mouth of the bay. 
...
Deep water turbidity was over 2 SD above the norm. 

<!-- 2-3 sentences -->

## Conditions

After a missed month due to the shutdown of the federal government, Hans, Kris, and Ross conducted the November survey, which included T9 across the bay from the Homer Spit and the AlongBay transect on 18 November. <!-- `{r} dateAN` , 
Sea state during this survey varied from Beaufort 1 to Beaufort 4. 
-->
After a slightly warmer than normal September (approaching the 90th percentile), temperatures during the month leading up to this survey were close to the long-term seasonal mean (@fig-Temp_Airport). Precipitation in Kachemak Bay is normaler highter in the fall than during summer, and this year followed this pattern. Precipitation amounts leading up to this survey were close to the long-term mean.
...
Recorded water temperatures during this survey ranged from a minimum of `{r} tsal$temSalR[1]` °C at station `{r} tsal$stn[1]` (`{r} tsal$depth[1]` m depth), in the inner bay off Glacier Spit, to a maximum of `{r} tsal$temSalR[2]` °C at `{r} tsal$stn[2]` (`{r} tsal$depth[2]` m depth) in the outer bay, off Seldovia. Throughout the bay, surface waters are now cooler than deep water layers, especially so in the inner bay. 

Deep water temperatures varied only slightly, but surface waters showed a distinctive area of cool water in the inner bay (@fig-tSections_AB). The low salinity and high turbidity of this area indicated that this was due a plume of glacial outflow, most likely from nearby Grewingk Glacier. 

The cross-bay transect of the Homer Spit (T9) was characterized by three distinct water masses of different temperatures: 1. cool waters at the northern end of the transect, especially near the surface (outflowing water from the inner bay, effectively air-cooled in shallow waters), 2. warmer water in the southern half of the transect (in-flowing oceanic water from the outer bay), and 3. warm waters pooling near the bottom (being denser than surface waters due to higher salinity, @fig-tSections_T9).

On a larger scale, satellite data showed a similar trend for sea surface temperatures, as observed here for Katchemak Bay, for Cook Inlet: warm waters from the Gulf of Alaska, gradually cooled, as they moved into the increasingly shallow waters of the upper inlet (@fig-SST_GOA). 
