...
Compared to the seasonal average, this August been warm and particularly dry. A warm-water anomaly that started at the beginning of the year, is ongoing throughout the water column and intensified this month. A low salinity anomaly that also started this year, was also ongoing and may now be the longest on record. Chlorophyll concentrations were highest in the outer bay. 
<!-- 2-3 sentences -->

## Conditions

This month, Karyn, Martin, and Ross conducted the regular survey, which includied T9 across the bay from the Homer Spit and the AlongBay transect on 13 August.  
<!-- `{r} dateAN` , -->
Sea state during this survey varied from Beaufort 0 to Beaufort 3.

So far, all samples from last month that were tested for domoic acid, a neuro toxin that can be produced by Pseudo-nitzschia diatoms, have come back below the detection threshold (Sarah Schoen, USGS, in lit.).
...
Recorded water temperatures during this survey ranged from a minimum of `{r} tsal$temSalR[1]` °C at station `{r} tsal$stn[1]` (`{r} tsal$depth[1]` m depth) in the outer bay to a maximum of `{r} tsal$temSalR[2]` °C at `{r} tsal$stn[2]` (`{r} tsal$depth[2]` m depth) near Bear Cove in the inner bay. In contrast to the previous month, but as seen in previous years, there was a gradual warming of midwater layers down to about 50 m XXX depth. This was likely due to thermal diffusion rather than mixing, since salinity did not show this pattern, but rather a sharply demarkated surface layer of fresher water. Waters near the mouth of the bay were more uniform in both, salinity, and temperature, indicating a mixed water column (@fix-tSections_AB).  
...
As last month, satellite observations showed an area of cooler surface water from lower Cook Inlet to Kodiak Island, which is indicative of mixing or upwelling in this area (@fig-SST_GOA). 
...
Salinity values ranged from `{r} tsal$temSalR[3]` PSU at `{r} tsal$stn[3]` (`{r} tsal$depth[3]`m depth) to `{r} tsal$temSalR[4]` at `{r} tsal$stn[4]` (`{r} tsal$depth[4]`m depth), near Bear Cove and Seldovia, respectively. As last month, typical summertime patterns were found along the estuary with a pronounced layer of fresher water in the inner bay, setting up strong vertical stratification over the more saline deeper waters (@fig-tSections_AB, @fig-tSections_T9). Since the beginning of the year, salinities at the mid-bay station T9-6 have been lower than the seasonal mean (@fig-SalDeep), particularly in waters below 25 m (@fig-TSprofile_T9). 
...
Even though several stations in the outer bay showed moderate to strong returns on the echo sounder, an oblique tow through the area of strongest returns only yielded few copepods, but not the expected abundance of zooplankton. 
<!-- Backscatter? Species composition? -->

### Wildlife

A group of two or three harbor porpoises were noted in the inner bay. In contrast to July, several shearwaters (sooty and short-tailed) were observed in the outer bay. This species is present in the Gulf of Alaska throughout the summer and fall, but for unknown reasons only rarely ventures into Kachemak Bay before mid-summer. 
