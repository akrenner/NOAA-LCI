...
With cool air temperatures, the warm-water anomaly that started at the beginning of the year was much diminished, however a fresh salinity anomaly was ongoing. Driven by freshwater influx, strong stratification of surface waters was extending from the inner into the outer bay. Chlorophyll concentrations in the inner bay had dropped from their peak last month and areas of highest concentration had shifted into the outer bay. Nutrient levels in the inner bay were likely depleted from the bloom last month with stratification preventing replenishment. Weaker stratification and proximity to upwelling in Cook Inlet were likely factors driving high chlorophyll concentrations in the outer bay through an ongoing supply of nutrients. 
...
Salinity values in May ranged from `{r} tsal$temSalR[3]` PSU at `{r} tsal$stn[3]` (`{r} tsal$depth[3]`m depth) to `{r} tsal$temSalR[4]` at `{r} tsal$stn[4]` (`{r} tsal$depth[4]`m depth), near Bear Cove and Seldovia, respectively. A substantial layer of fresher water, from the surface down to about 25 m depth was present in all but the outermost parts of the bay (@fig-tSections). This stratification is a defining feature of the summer months. In contrast to earlier months, this low salinity layer now extends well past the more sheltered waters of the inner bay (@fig-tSections_AB). As indicated by the Brunt–Väisälä frequency (bvf, @fig-tSections_AB), there is some stratification extending all the way to the outer bay, however, water column stability there is much weaker than in the inner bay. Even though the survey this month did not extend into lower Cook Inlet, the satellite SST data showed a pocket of cool water in lower Cook Inlet, surrounded by warmer waters (@fig-SST_GOA). The most likely cause is local upwelling (likely driven by the strong tidal currents in that area). We would predict that the water column in these areas is still fully mixed. 

Since the beginning of the year, salinity at T9-6 has been lower than the seasonal mean (@fig-SalDeep). In contrast to the temperature anomaly, the salinity anomaly was ongoing. The magnitude of this anomaly is now the third-largest such event in thirteen years of observations (@fig-SalDeep). 
...
Strong stratification of the water column in the inner bay is an effective barrier to vertical mixing. This is likely the reason for the observed drop in chlorophyll concentrations. The plankton bloom last month depleted nutrient concentrations and stratification prevented their replenishment. High chlorophyll concentrations in the outer bay were likely due to resupply from Cook Inlet and weaker vertical stratification forming only recently. 
